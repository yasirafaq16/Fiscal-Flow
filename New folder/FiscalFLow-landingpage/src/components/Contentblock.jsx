      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`flex flex-col ${reversed ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16`}>
          ...
          <div className="flex-1 space-y-8">
            ...
            <button className="bg-black text-white font-bold px-6 py-2.5 rounded-full shadow-lg shadow-gray-200 transition-all duration-300 hover:bg-gray-800 hover:shadow-gray-300 active:scale-95">
