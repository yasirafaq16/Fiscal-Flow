        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-transparent border border-gray-600 text-white-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100  hover:text-blue-700 transition-colors shadow-lg">
              Get Started Now
            </button>
            <button className="bg-transparent border border-gray-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white-100  hover:text-blue-700 transition-colors">
              Contact Us
            </button>
          </div>
