      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <img src={logo} alt="Fiscal Flow" className="w-6 h-6 rounded" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><Link to="/import-guide" className="hover:text-black transition-colors">Import Guide</Link></li>
              <li><Link to="/security" className="hover:text-black transition-colors">Security</Link>
              </li>
              <li><Link to="/updates" className="hover:text-black transition-colors">Updates</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><Link to="/blog" className="hover:text-black transition-colors">Blog</Link>
              </li>
              <li><Link to="/contact" className="hover:text-black transition-colors">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><Link to="/privacy" className="hover:text-black transition-colors">Privacy</Link>
              </li>
              <li><Link to="/terms" className="hover:text-black transition-colors">Terms</Link>
              </li>
              <li><Link to="/cookies" className="hover:text-black transition-colors">Cookies</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a
  href="https://github.com/yasirafaq16/Fiscal-Flow-Frontend"
  target="_blank"
  rel="noopener noreferrer"
